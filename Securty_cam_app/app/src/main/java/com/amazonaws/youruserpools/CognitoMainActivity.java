...
import com.ayalgenzer.security_cam.R;

import java.util.Locale;
import java.util.Map;

public class CognitoMainActivity extends AppCompatActivity {
    private final String TAG="CognitoMainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cognito_activity_main);
