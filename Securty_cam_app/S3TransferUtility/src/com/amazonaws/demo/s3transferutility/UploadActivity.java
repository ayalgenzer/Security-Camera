...
public class UploadActivity extends ListActivity {
        ...
        simpleAdapter.setViewBinder(new ViewBinder() {
            ...
            public boolean setViewValue(View view, Object data,
                ...
                if (i == R.id.radioButton1) {
                    ...
                    return true;
                } else if (i == R.id.textFileName) {
                    TextView fileName = (TextView) view;
                    fileName.setText((String) data);
                    return true;
                } else if (i == R.id.progressBar1) {
                    ProgressBar progress = (ProgressBar) view;
                    progress.setProgress((Integer) data);
                    return true;
                } else if (i == R.id.textBytes) {
    ...
    private void beginUpload(String filePath) {
        ...
        TransferObserver observer = transferUtility.upload(S3_MainActivity.bucket_name, file.getName(),
                file);
        /*
